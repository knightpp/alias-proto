...
const (
	GameService_ListRooms_FullMethodName  = "/game_service.GameService/ListRooms"
	GameService_CreateRoom_FullMethodName = "/game_service.GameService/CreateRoom"
	GameService_Join_FullMethodName       = "/game_service.GameService/Join"
)
