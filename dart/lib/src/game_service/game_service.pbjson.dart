...
const Room$json = const {
  ...
  '2': const [
    ...
    const {'1': 'player_id_turn', '3': 8, '4': 1, '5': 9, '10': 'playerIdTurn'},
  ],
};

/// Descriptor for `Room`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List roomDescriptor = $convert.base64Decode('');
